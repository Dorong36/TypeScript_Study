...
// 함수도 됨
function hellofun(a : 'hello'): 1 | 2{
    console.log(a);
    return 1;
}

// Q1
function rsp07(choice : 'rock' | 'sissor' | 'paper'):('rock' | 'sissor' | 'paper')[]{
...
function fun07(a : 'kim'):void{ // 이 함수는 literal type으로 변수로 kim만을 받음
    console.log(a)
}
...
*/
// 솔루션1 - 선언시 데이터타입 맞춰주기
var data07_1:{name : 'kim'} = {
    name : 'kim'
}
// 솔루션2 - Assertion 사용
fun07(data07.name as 'kim')
