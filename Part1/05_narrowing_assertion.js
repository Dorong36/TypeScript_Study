...
// ✅ Assertion => 타입 덮어쓰기
function narrowingFun3(x) {
    var narrArr = [];
    narrArr[0] = x; // 변수 as 자료형 => 변수를 지정한 자료형으로 덮어 써주세요~
    // 편하다고 남용하면 빠따맞음
...
var teacher2 = { subject: ['korean', 'science'] };
